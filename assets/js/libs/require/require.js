...
(function(Z) {
		...
		X.prototype = {
							...
							if (!this.defining) {
								...
								if (1 > this.depCount && !this.defined) {
									if (H(m)) {
										...
										void 0 !== b.exports && b.exports !== this.exports ? e = b.exports :
			...
			callPlugin : function() {
				...
				t(d, "defined", u(this, function(e) {
					var m, d;
					d = this.map.name;
					var g = this.map.parentMap ? this.map.parentMap.name : null, h = i.makeRequire(a.parentMap, {
			...
			completeLoad : function(a) {
				...
				if (!b && !s(r, a) && c && !c.inited) {
					if (k.enforceDefine && (!d || !ba(d)))
						return h(a) ?
						void 0 : v(A("nodefine", "No define call for " + a, null, [a]));
	...
	if ("undefined" === typeof define) {
		...
		"undefined" !== typeof require && !H(require) && ( t = require, require =
		void 0);
		...
		z && M(document.getElementsByTagName("script"), function(b) {
			...
			if ( J = b.getAttribute("data-main"))
				return q = J, t.baseUrl || ( D = q.split("/"), q = D.pop(), fa = D.length ? D.join("/") + "/" : "./", t.baseUrl = fa), q = q.replace(ea, ""), j.jsExtRegExp.test(q) && ( q = J), t.deps = t.deps ? t.deps.concat(q) : [q], !0
		});
